...
@Component({
  selector: 'bcs-characters',
  templateUrl: 'bcs-characters.component.html',
  styleUrls: ['bcs-characters.component.less']
})
export class BCSCharactersComponent implements OnInit, OnDestroy {
  /**
  ...
  /**
   * Query a slice of the Better Call Saul characters from the store to be
   * displayed for a particular page.
  ...
  private queryCharacters(page: number, maxPerPage: number) {
    this.subscriptions.add(
      combineQueries([
        this.query.selectBetterCallSaulCharacters(page, maxPerPage),
